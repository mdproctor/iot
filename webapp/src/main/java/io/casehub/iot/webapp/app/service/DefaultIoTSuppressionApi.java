...
@McpDomain(value = "iot/situations/suppressions", app = "iot", basePath = "/api/situations/suppressions", summary = "List suppression history; Override a suppression; Get suppression statistics for a situation")
@ApplicationScoped
